...
void GridScene::MakeMesh()
{
    ...
    for (int x = -halfW; x <= halfW; x++)
    {
        ...
        if (x % 4 == 0)
        {
            vertices.emplace_back(x, 0, -halfH, fourBaseGridColor.x, fourBaseGridColor.y, fourBaseGridColor.z);
            vertices.emplace_back(x, 0, +halfH, fourBaseGridColor.x, fourBaseGridColor.y, fourBaseGridColor.z);
        }
        else
        {
            vertices.emplace_back(x, 0, -halfH, baseGridColor.x, baseGridColor.y, baseGridColor.z);
            vertices.emplace_back(x, 0, +halfH, baseGridColor.x, baseGridColor.y, baseGridColor.z);
        }
    }
    ...
    for (int z = -halfH; z <= halfH; z++)
    {
        ...
        if (z % 4 == 0)
        {
            vertices.emplace_back(-halfW, 0, z, fourBaseGridColor.x, fourBaseGridColor.y, fourBaseGridColor.z);
            vertices.emplace_back(+halfW, 0, z, fourBaseGridColor.x, fourBaseGridColor.y, fourBaseGridColor.z);
        }
        else
        {
            vertices.emplace_back(-halfW, 0, z, baseGridColor.x, baseGridColor.y, baseGridColor.z);
            vertices.emplace_back(+halfW, 0, z, baseGridColor.x, baseGridColor.y, baseGridColor.z);
        }
    }    
}
