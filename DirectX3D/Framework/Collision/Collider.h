...
public:
    ...
    virtual bool IsPointCollision(Vector2 point) { return false; }

    virtual bool IsRayCollision(IN Ray ray, OUT Contact* contact = nullptr) { return false; }
    virtual bool IsBoxCollision(class BoxCollider* collider) { return false; }
    virtual bool IsSphereCollision(class SphereCollider* collider) { return false; }
    virtual bool IsCapsuleCollision(class CapsuleCollider* collider) { return false; }
